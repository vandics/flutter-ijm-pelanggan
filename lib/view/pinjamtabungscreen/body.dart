...
import 'package:mobile_app_ijm_pelanggan/view/pinjamtabungscreen/listitem.dart';
...
class _BodyState extends State<Body> {
  List<ProductCart> tabungbaru = [
    ProductCart(
        namaProduk: "Pinjam ${item[0].tabungsize}",
        price: 45000,
        amount: item[0].amount,
        id: 'C'),
    ProductCart(
        namaProduk: "Pinjam ${item[1].tabungsize}e",
        price: 45000,
        amount: item[1].amount,
        id: 'C'),
    ProductCart(
        namaProduk: "Pinjam ${item[2].tabungsize}",
        price: 45000,
        amount: item[2].amount,
        id: 'C'),
    ProductCart(
        namaProduk: "Pinjam ${item[3].tabungsize}",
        price: 45000,
                      ...
                      tabungbaru.forEach((element) {
                        if (element.amount > 0) {
                          productBloc.add(AddProductToCart(
                              namaProduk: "Pinjam ${element.namaProduk}",
                              product: element));
